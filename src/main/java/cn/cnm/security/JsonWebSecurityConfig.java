...
public class JsonWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public JsonWebSecurityConfig(@Qualifier(value = "webUserDetailsService") UserDetailsService webUserDetailsService, @Qualifier("webUserDao") WebUserDaoImpl webUserDao) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                //异常处理 默认 权限不足  返回403，可以在这里自定义返回内容
                .exceptionHandling()
    ...
    // 登录 filter
    static class JsonAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
